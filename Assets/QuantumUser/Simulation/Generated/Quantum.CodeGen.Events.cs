...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventMarioPlayerChangedAction.ID: result = typeof(EventMarioPlayerChangedAction); return;
      ...
      public EventMarioPlayerChangedAction MarioPlayerChangedAction(EntityRef Entity, PlayerAction ActionType, ActionFlags ActionFlags, Int32 ActionArg) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerChangedAction>(EventMarioPlayerChangedAction.ID);
        ev.Entity = Entity;
        ev.ActionType = ActionType;
        ev.ActionFlags = ActionFlags;
        ev.ActionArg = ActionArg;
        _f.AddEvent(ev);
        return ev;
      }
  ...
  public unsafe partial class EventMarioPlayerChangedAction : EventBase {
    public new const Int32 ID = 47;
    public EntityRef Entity;
    public PlayerAction ActionType;
    public ActionFlags ActionFlags;
    public Int32 ActionArg;
    protected EventMarioPlayerChangedAction(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerChangedAction() : 
