...
namespace Quantum {
    ...
    public unsafe partial struct FrameEvents {
      ...
      static partial void GetEventTypeCodeGen(Int32 eventID, ref System.Type result) {
        switch (eventID) {
          ...
          case EventMarioPlayerIncrementPropellerScore.ID: result = typeof(EventMarioPlayerIncrementPropellerScore); return;
          case EventMarioPlayerChangedPropeller.ID: result = typeof(EventMarioPlayerChangedPropeller); return;
          case EventMarioPlayerSetPropellerTime.ID: result = typeof(EventMarioPlayerSetPropellerTime); return;
      ...
      public EventMarioPlayerIncrementPropellerScore MarioPlayerIncrementPropellerScore(EntityRef Entity) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerIncrementPropellerScore>(EventMarioPlayerIncrementPropellerScore.ID);
        ev.Entity = Entity;
        _f.AddEvent(ev);
        return ev;
      }
      public EventMarioPlayerChangedPropeller MarioPlayerChangedPropeller(EntityRef Entity, QBoolean isRandom) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerChangedPropeller>(EventMarioPlayerChangedPropeller.ID);
        ev.Entity = Entity;
        ev.isRandom = isRandom;
        _f.AddEvent(ev);
        return ev;
      }
      public EventMarioPlayerSetPropellerTime MarioPlayerSetPropellerTime(PlayerRef Player, FP amount) {
        var ev = _f.Context.AcquireEvent<EventMarioPlayerSetPropellerTime>(EventMarioPlayerSetPropellerTime.ID);
        ev.Player = Player;
        ev.amount = amount;
        _f.AddEvent(ev);
        return ev;
  ...
  public unsafe partial class EventMarioPlayerIncrementPropellerScore : EventBase {
    public new const Int32 ID = 72;
    public EntityRef Entity;
    protected EventMarioPlayerIncrementPropellerScore(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerIncrementPropellerScore() : 
  ...
  public unsafe partial class EventMarioPlayerChangedPropeller : EventBase {
    public new const Int32 ID = 73;
    public EntityRef Entity;
    public QBoolean isRandom;
    protected EventMarioPlayerChangedPropeller(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerChangedPropeller() : 
    ...
    public override Int32 GetHashCode() {
      unchecked {
        var hash = 439;
        hash = hash * 31 + Entity.GetHashCode();
        hash = hash * 31 + isRandom.GetHashCode();
        return hash;
      }
    }
  }
  public unsafe partial class EventMarioPlayerSetPropellerTime : EventBase {
    public new const Int32 ID = 74;
    public PlayerRef Player;
    public FP amount;
    protected EventMarioPlayerSetPropellerTime(Int32 id, EventFlags flags) : 
        base(id, flags) {
    }
    public EventMarioPlayerSetPropellerTime() : 
