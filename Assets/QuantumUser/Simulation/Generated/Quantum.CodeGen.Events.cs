...
namespace Quantum {
  ...
  public unsafe partial class Frame {
    public unsafe partial struct FrameEvents {
      ...
      public EventMarioPlayerCollectedStar MarioPlayerCollectedStar(EntityRef Entity, MarioPlayer Mario, FPVector2 Position, EntityRef StarEntity) {
      ...
      public EventBigCollectableSpawned BigCollectableSpawned(Int32 UsedSpawns, Int32 PositionIndex, FPVector2 Position, QBoolean WasBlocked) {
        if (_f.IsPredicted) return null;
        var ev = _f.Context.AcquireEvent<EventBigCollectableSpawned>(EventBigCollectableSpawned.ID);
        ev.UsedSpawns = UsedSpawns;
  ...
  public unsafe partial class EventBigCollectableSpawned : EventBase {
    ...
    public override Int32 GetHashCode() {
      unchecked {
        var hash = 53;
        hash = hash * 31 + UsedSpawns.GetHashCode();
